...
class dAUTOMAP(nn.Module):
    ...
    def __init__(self, input_shape, output_shape, tfx_params, tfx_params2=None):
        ...
        self.refinement_block = get_refinement_block('simple', input_shape[0], output_shape[0])    #automap_scae
...
class Wnet(nn.Module):
    ...
    def forward(self,input_kspace,maxi):
        ...
        # maxi2 = T.complex_abs(T.ifft2(ksp_pred)).max()
        
        img_pred =T.complex_abs(T.ifft2(ksp_pred)).unsqueeze(1)
        maxi2 = img_pred.max()
